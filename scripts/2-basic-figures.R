...
pdf(file = "results/basic-figures/SpatialFeaturePlot_UMI_count.pdf",
    height = 6,
    width = 12.75,
    useDingbats = F)
...
p2 <- LabelClusters(plot = p,
              ...
              label.size = 0)
pdf(file = "results/basic-figures/DimPlot.pdf",
    height = 6,
    width = 8,
    useDingbats = F)
print(p2)
...
pdf(file = "results/basic-figures/DimPlot_surgery.pdf",
    height = 6,
    width = 8,
    useDingbats = F)
